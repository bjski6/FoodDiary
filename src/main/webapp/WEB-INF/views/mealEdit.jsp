                ...
                <form:form modelAttribute="meal" method="post">
                    <div class="mt-4 ml-4 mr-4">
                        <div class="row border-bottom border-3">
                            <div class="col"><h3 class="color-header text-uppercase">Edytuj posiłek</h3></div>
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Składniki
                                    <br>
                                    <a href="/mealProductAdd" >Dodaj</a>
                                </th>
                                <td class="col-3">
                                    <c:forEach items="${productList}" var="product">
                                        <c:out value="${product.name} (${product.weight}g)"/>
                                        <a href="/deleteProduct/${product.id}" class="rightSide">Usuń</a>
                                       <br>
                                    </c:forEach>
                                </td>
                            </tr>
